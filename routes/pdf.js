...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cover-watermark { position:absolute;bottom:0.45in;left:50%;transform:translate(-50%,50%);font-family:'Cinzel',serif;font-size:8pt;line-height:1;color:rgba(201,168,76,0.4);background:#0a0604;padding:0 0.12in;letter-spacing:0.15em;z-index:1; }
