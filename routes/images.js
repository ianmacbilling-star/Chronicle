...
function getStylePrefix(style) {
  var prefixes = {
    ...
    'Fantasy oil painting': 'STYLE: Fantasy oil painting inspired by classic sword-and-sorcery cover art and old fantasy rulebook art plates. LARGE, bold, loose brushstrokes with thick visible impasto and broad palette-knife marks, where each individual stroke of paint is clearly visible. Rich, saturated oil-paint textures, dramatic lighting, bold high-contrast highlights. Heroic anatomy, powerful poses, sculpted musculature. Epic, atmospheric backgrounds with mist, firelight, or stormy skies. Deep intense colors, warm skin tones, metallic reflections. UNFRAMED vignette composition: the painting is fully rendered on only ONE or TWO edges and dissolves into bare, unpainted parchment on the remaining edges, with loose ragged fading borders and NO rectangular frame, like an illustration printed in the margin of a fantasy rulebook page.',
    ...
    'Fantasy pastel': 'STYLE: Fantasy pastel and soft-chalk art. BOLD, large chalk and pastel strokes with thick, visible, grainy chalk marks and broad soft-pastel sweeps, generous smudging, and the texture of chalk dragged across rough paper. Soft, blended pastel colors with gentle gradients and a dreamy, magical atmosphere. Warm light, glowing highlights, a whimsical airy feeling. Lightly stylized, ethereal, expressive characters. UNFRAMED vignette composition: fully drawn on only ONE or TWO edges and dissolving into bare, untouched paper on the remaining edges, with loose feathered fading chalk borders and NO rectangular frame, like an illustration in the margin of a fantasy rulebook page.',
    'Charcoal drawing': 'STYLE: Traditional charcoal drawing on rough paper. Rich, textured charcoal strokes with deep velvety blacks, soft smudged mid-tones, and subtle blended shading. Hand-drawn edges that feel slightly rough, with visible charcoal grain and the tooth of the paper showing through. Bold, expressive shadows with dramatic high contrast and areas of heavy shading. Minimal highlights, created by leaving the bare paper exposed rather than adding bright tones. A traditional, tactile, sketch-based monochrome charcoal look, like an artist working with charcoal sticks and blending stumps on rough paper.'
  };
