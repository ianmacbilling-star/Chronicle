...
function getStylePrefix(style) {
  var prefixes = {
    ...
    'Fantasy oil painting': 'STYLE: Fantasy oil painting inspired by classic sword-and-sorcery cover art. Rich, saturated oil-paint textures, dramatic lighting, bold high-contrast highlights. Heroic anatomy, powerful poses, sculpted musculature. Epic, atmospheric backgrounds with mist, firelight, or stormy skies. Deep intense colors, warm skin tones, metallic reflections. Visible, painterly, dynamic brushwork. Soft, borderless edges that fade naturally into the page with no hard frame.',
    'Comic book cel-shaded': 'STYLE: Comic-book cel-shaded art in the style of Borderlands. Thick black ink outlines around characters, props, and major shapes. Cel-shaded lighting with sharp, high-contrast shadow blocks instead of smooth gradients. Hand-painted, marker-filled textures with visible strokes and sketch lines. Bold, slightly desaturated, graphic-novel colors. Exaggerated silhouettes, expressive faces, stylized proportions.',
    'Hyper-realistic': 'STYLE: Hyper-realistic rendering. Extremely detailed textures, lifelike lighting, and physically accurate materials. Skin, fabric, metal, and environmental surfaces appear photographic and high-fidelity. Shadows and reflections follow realistic physics. Avoid stylization; prioritize accuracy, clarity, and fine detail. Natural, expressive characters fully grounded in the environment.',
    'Fantasy pastel': 'STYLE: Fantasy pastel art. Soft, blended pastel colors with gentle gradients and a dreamy, magical atmosphere. Lightly smudged or feathered edges, as if drawn with chalk or soft watercolor washes. Warm light, glowing highlights, whimsical airy feeling. Hand-brushed, delicate textures with minimal hard lines. Ethereal, expressive, lightly stylized characters. Soft, borderless edges that fade naturally into the page with no hard frame.'
  };
