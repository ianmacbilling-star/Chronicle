-- Campaignia -- seed version_releases for STAGING.
-- v3.0.952, TD-804 batch C. Generated 2026-09-18 from the git history, not by hand.
--
-- RUN THIS ONCE, AGAINST STAGING ONLY.
--
-- The dates: the commit date on origin/staging, which is when staging was pushed the version.
--
...
INSERT INTO version_releases (version, first_seen) VALUES
  ...
  ('3.0.815', TIMESTAMP '2026-09-01 12:00:00'),
  ('3.0.816', TIMESTAMP '2026-09-01 12:00:00'),
  ('3.0.819', TIMESTAMP '2026-09-01 12:00:00'),
  ...
  ('3.0.929', TIMESTAMP '2026-09-16 12:00:00'),
  ('3.0.939', TIMESTAMP '2026-09-16 12:00:00'),
  ('3.0.940', TIMESTAMP '2026-09-16 12:00:00'),
  ...
  ('3.0.949', TIMESTAMP '2026-09-18 12:00:00'),
  ('3.0.950', TIMESTAMP '2026-09-18 12:00:00'),
  ('3.0.951', TIMESTAMP '2026-09-18 12:00:00')
